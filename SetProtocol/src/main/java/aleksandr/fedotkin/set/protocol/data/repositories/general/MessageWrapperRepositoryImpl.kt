...
class MessageWrapperRepositoryImpl<T : Model, R : DTO>(
    ...
    override suspend fun <S : Model> changeMessageModelOnOther(
        ...
        return changeMessageModelOnOther(message, messageWrapperModel).apply {
            changeRRPID(rrpid = rrpid, messageWrapperModel = this)
        }
    }
    ...
    override suspend fun changeMessageModel(
        ...
        return changeMessageModel(messageModel, messageWrapperModel).apply {
            changeRRPID(rrpid = rrpid, messageWrapperModel = this)
        }
    }
    ...
    override suspend fun changeRRPID(
        rrpid: BigInteger,
        messageWrapperModel: MessageWrapperModel<*>,
    ): MessageWrapperModel<*> {
