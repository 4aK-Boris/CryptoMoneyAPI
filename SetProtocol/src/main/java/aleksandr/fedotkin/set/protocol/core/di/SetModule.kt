...
import aleksandr.fedotkin.set.protocol.data.di.setNetworkModule
import aleksandr.fedotkin.set.protocol.domain.di.useCasesModule
import org.koin.dsl.module

val setModule = module {
    includes(repositoriesModule, mappersModule, cryptoModule, useCasesModule, setNetworkModule, certificateModule)
}